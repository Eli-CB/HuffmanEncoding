...
//  clock_t begin = clock();	
  ...
  bool notValid = true;
	...
	int bits_for_safe_shifting;		//ELISMAJOR
    ...
    int bit_to_add = 0;
    int index = 1;
	int* data_stream = (int*)malloc((strlen(str)*bits_for_safe_shifting)+2);
	if (data_stream == NULL) {                           
		//printf("Memory allocation failed");
		return 0;
	}
